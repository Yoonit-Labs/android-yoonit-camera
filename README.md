...
| setFaceROIAreaOffsetColor    | `alpha: Int, red: Int, green: Int, blue: Int`   | Any positive integer between 0 and 255                                          | void        | Set face region of interest area offset color.
