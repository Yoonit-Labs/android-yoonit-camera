...
| setFaceContoursColor         | `alpha: Int, red: Int, green: Int, blue: Int`   | Positive value between 0 and 255                                                | void        | Set to show/hide face contours when face detected.
| setFaceContours              | `enable: Bool`                                  | `true` or `false`                                                               | void        | Set face contours ARGB color.
