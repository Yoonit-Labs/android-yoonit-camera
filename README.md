...
| **`setFaceROIOffset`**          | `topOffset: Float, rightOffset: Float, bottomOffset: Float, leftOffset: Float` | Values between `0` and `1`. Represents the percentage.                            | void         | <ul><li>topOffset: "Above" the face region.</li><li>rightOffset: "Right" of the face region.</li><li>bottomOffset: "Bottom" of the face region.</li><li>leftOffset: "Left" of the face region.</li></ul>
| **`getFaceROIOffset`**          | -                                                                              | -                                                                                 | Array<Float> | Return `Array<Float>([topOffset, rightOffset, bottomOffset, leftOffset])` of the face region of interest offset values. Default value is [200, 200, 200, 200].
